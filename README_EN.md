...
> - **Current release gate**: The validation hotfix passes locally; exact `v2.3.0-alpha.2` main-commit Ubuntu/Windows CI is pending. This remains an alpha prerelease with the warnings documented below.
