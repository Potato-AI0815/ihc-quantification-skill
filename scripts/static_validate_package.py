...
REQUIRED = [
    ...
    "external_validation/VALIDATION_METADATA.json",
    "tests/verify_hpa_checkpoint_resume.R",
    "tests/verify_summary_generator_determinism.py",
    ...
    "tests/verify_if_physical_scale_contract.R",
    "tests/verify_if_colocalization_qc_contract.R",
    "tests/approved_v232_if_core.patch",
